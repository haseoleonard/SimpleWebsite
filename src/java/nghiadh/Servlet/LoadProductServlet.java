...
import nghiadh.products.ProductsDAO;
import nghiadh.products.ProductsDTO;
...
public class LoadProductServlet extends HttpServlet {
    private final String ONLINE_STORE_PAGE = "onlineStorePage";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //
        String url = resourceMap.get(ONLINE_STORE_PAGE);
        try {
